...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/vibrations-through-a-rotary-joint/transmission_design.png){: .align-center style="max-width: 80%;"}
